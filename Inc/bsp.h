...
#define GET_DC_PRESNT 		HAL_GPIO_ReadPin(BMGR_DCOKn_GPIO_Port, BMGR_DCOKn_Pin)
...
#define GET_CHARGE_STATUS 	HAL_GPIO_ReadPin(BMGR_GPIO1_GPIO_Port, BMGR_GPIO1_Pin)
#define GET_BATT_UV_STATUS 	HAL_GPIO_ReadPin(BMGR_GPIO2_GPIO_Port, BMGR_GPIO2_Pin)
#define GET_CAL_CMPLT 		HAL_GPIO_ReadPin(BMGR_GPIO3_GPIO_Port, BMGR_GPIO3_Pin)
#define GET_DC_PRESNT 		HAL_GPIO_ReadPin(BMGR_DCOKn_GPIO_Port, BMGR_DCOKn_Pin)
#define DC_POWER_DISABLE HAL_GPIO_WritePin(BMGR_SHDN_GPIO_Port,BMGR_SHDN_Pin,GPIO_PIN_SET)
#define DC_POWER_ENABLE HAL_GPIO_WritePin(BMGR_SHDN_GPIO_Port,BMGR_SHDN_Pin,GPIO_PIN_RESET)
