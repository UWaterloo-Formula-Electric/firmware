...
#define FRONT_ENCODER_A_Pin GPIO_PIN_9
#define FRONT_ENCODER_A_GPIO_Port GPIOE
#define FRONT_ENOCDER_B_Pin GPIO_PIN_11
#define FRONT_ENOCDER_B_GPIO_Port GPIOE
#define REAR_HALL_EFFECT_ENCODER_Pin GPIO_PIN_13
#define REAR_HALL_EFFECT_ENCODER_GPIO_Port GPIOE
#define REAR_HALL_EFFECT_ENCODER_EXTI_IRQn EXTI15_10_IRQn
