...
#define SENSOR1_IC_IN_Pin GPIO_PIN_9
#define SENSOR1_IC_IN_GPIO_Port GPIOE
#define SENSOR1_IC_IN_EXTI_IRQn EXTI9_5_IRQn
#define SENSOR2_IC_IN_Pin GPIO_PIN_11
