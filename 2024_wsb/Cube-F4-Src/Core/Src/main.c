...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pins : FrontRear_DipSW_Pin LeftRight_DipSW_Pin SENSOR1_IC_IN_Pin SENSOR2_IC_IN_Pin
                           SENSOR3_IC_IN_Pin */
  ...
  /*Configure GPIO pin : DP83848CVV_nRESET_Pin */
  ...
  /*Configure GPIO pin : DP83848CVV_RX_ER_Pin */
  ...
  /*Configure GPIO pin : DP83848CVV_INT_Pin */
  ...
  /*Configure GPIO pin : FW_HEARTBEAT_Pin */
