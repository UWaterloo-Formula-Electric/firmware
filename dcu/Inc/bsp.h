...
#define ENDURANCE_TOGGLE_BUTTON_PIN  BTN_ENDURANCE_TOGGLE_READ_Pin
#define ENDURANCE_TOGGLE_BUTTON_PORT  BTN_ENDURANCE_TOGGLE_READ_GPIO_Port
#define ENDURANCE_LAP_BUTTON_PIN BTN_ENDURANCE_LAP_READ_Pin
#define ENDURANCE_LAP_BUTTON_PORT BTN_ENDURANCE_LAP_READ_GPIO_Port

#define SCR_NAV_R_BUTTON_PIN BTN_NAV_R_READ_Pin
#define SCR_NAV_R_BUTTON_PORT BTN_NAV_R_READ_GPIO_Port
#define SCR_NAV_L_BUTTON_PIN BTN_NAV_L_READ_Pin
#define SCR_NAV_L_BUTTON_PORT BTN_NAV_L_READ_GPIO_Port
...
#define ENDURANCE_LED_Pin       ENDURANCE_MODE_LED_EN_Pin
#define ENDURANCE_LED_GPIO_Port ENDURANCE_MODE_LED_EN_GPIO_Port
...
#define AMS_FAIL_LED_ON HAL_GPIO_WritePin(AMS_LED_EN_GPIO_Port, AMS_LED_EN_Pin, GPIO_PIN_SET);
#define AMS_FAIL_LED_OFF HAL_GPIO_WritePin(AMS_LED_EN_GPIO_Port, AMS_LED_EN_Pin, GPIO_PIN_RESET);
