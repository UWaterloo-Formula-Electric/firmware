##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.0.0] date: [Wed Dec 05 17:14:18 CET 2018] 
##########################################################################################################################
...
LIB_CC = $(PREFIX)gcc
LIB_AS = $(PREFIX)gcc -x assembler-with-cpp
LIB_CP = $(PREFIX)objcopy
LIB_SZ = $(PREFIX)size
endif
LIB_HEX = $(CP) -O ihex
LIB_BIN = $(CP) -O binary -S
