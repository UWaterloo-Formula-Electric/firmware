...
void buttonTask(void *pvParameters)
{
    ...
    while (1)
    {
        ...
        state[index] |= (HAL_GPIO_ReadPin(COOLER_BUTTON_PORT, COOLER_BUTTON_PIN) == GPIO_PIN_RESET) << COOLER_TOGGLE_OFFSET;
        ...
        case 1u << ENDURANCE_TOGGLE_OFFSET:
            ...
            break;
        case 1u << COOLER_TOGGLE_OFFSET:
            DEBUG_PRINT("received cooler button\n");
            fsmSendEvent(&VCUFsmHandle, EV_BTN_CO_Toggle, portMAX_DELAY);
            break;
        case 0:
            // No button pressed
            break;
