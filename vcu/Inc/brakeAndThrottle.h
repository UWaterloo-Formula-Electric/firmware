...
#define THROTT_A_LOW (2119)
#define THROTT_B_LOW (1768)

#define THROTT_A_HIGH (2442)
#define THROTT_B_HIGH (2134)

#define BRAKE_POS_LOW (1336)
#define BRAKE_POS_HIGH (1613)
