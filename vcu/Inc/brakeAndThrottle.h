...
#define TPS_TOLERANCE_PERCENT 40
#define TPS_MAX_WHILE_BRAKE_PRESSED_PERCENT 80
#define TPS_WHILE_BRAKE_PRESSED_RESET_PERCENT 10

#define THROTT_A_LOW (2281)
#define THROTT_B_LOW (2159)

#define THROTT_A_HIGH (2496) 
#define THROTT_B_HIGH (2380)
