...
#define BRAKE_POSITION_PRESSURE_TOLERANCE_PERCENT 15.0f
...
#define THROTT_A_LOW (330)
#define THROTT_B_LOW (1960)

#define THROTT_A_HIGH (2180)
#define THROTT_B_HIGH (3810)

#define BRAKE_POS_LOW (180)
#define BRAKE_POS_HIGH (215)
