...
#define FCLK_SLOW() { MODIFY_REG(hspi4.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_128); }	/* Set SCLK = slow, approx 280 KBits/s*/
#define FCLK_FAST() { MODIFY_REG(hspi4.Instance->CR1, SPI_BAUDRATEPRESCALER_256, SPI_BAUDRATEPRESCALER_8); }	/* Set SCLK = fast, approx 4.5 MBits/s */
...
{
	BYTE rxDat;
    HAL_SPI_TransmitReceive(&hspi4, &dat, &rxDat, 1, 50);
    return rxDat;
}
