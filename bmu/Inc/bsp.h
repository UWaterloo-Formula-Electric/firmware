...
#define DC_DC_ON            HAL_GPIO_WritePin(MCU_EN_DC_GPIO_Port,MCU_EN_DC_Pin,GPIO_PIN_SET);
#define DC_DC_OFF           HAL_GPIO_WritePin(MCU_EN_DC_GPIO_Port,MCU_EN_DC_Pin,GPIO_PIN_RESET);
