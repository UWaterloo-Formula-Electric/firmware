...
#define TSSI_RED_ON         HAL_TIM_PWM_Start(&TSSI_PWM_HANDLE, TIM_CHANNEL_1);
#define TSSI_RED_OFF        HAL_TIM_PWM_Stop(&TSSI_PWM_HANDLE, TIM_CHANNEL_1);
