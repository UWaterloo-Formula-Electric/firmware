...
#define CONFIG_BYTE_DEFAULT_CONFIG 0b10010000
#define CONFIG_BYTE_SET_16BIT_RESOLUTION 0b1000
#define CONFIG_BYTE_SET_PGA_GAIN_1VV 0b00
#define CONFIG_BYTE (CONFIG_BYTE_DEFAULT_CONFIG | CONFIG_BYTE_SET_16BIT_RESOLUTION)
#define CONFIG_BYTE_SIZE 1
#define CONFIG_RDY_BIT_MASK 0b10000000
