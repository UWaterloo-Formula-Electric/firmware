...
COMMON_LIB_SRC = userCan.c debug.c state_machine.c CRC_CALC.c freertos_openocd_hack.c FreeRTOS_CLI.c generalErrorHandler.c watchdog.c canHeartbeat.c canReceiveCommon.c
