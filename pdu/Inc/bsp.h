...
#define RADIATOR_1_EN HAL_GPIO_WritePin(RAD_EN_GPIO_Port, RAD_EN_Pin, GPIO_PIN_SET)
#define RADIATOR_1_DISABLE HAL_GPIO_WritePin(RAD_EN_GPIO_Port, RAD_EN_Pin, GPIO_PIN_RESET)
...
#define ACC_FANS_2_EN HAL_GPIO_WritePin(ACC_FANS_EN_GPIO_Port, ACC_FANS_EN_Pin, GPIO_PIN_SET)
#define ACC_FANS_2_DISABLE HAL_GPIO_WritePin(ACC_FANS_EN_GPIO_Port, ACC_FANS_EN_Pin, GPIO_PIN_RESET)
...
#define MOTEC_EN HAL_GPIO_WritePin(TCU_EN_GPIO_Port, TCU_EN_Pin, GPIO_PIN_SET)
#define MOTEC_DISABLE HAL_GPIO_WritePin(TCU_EN_GPIO_Port, TCU_EN_Pin, GPIO_PIN_RESET)
#define ACC_FANS_1_EN HAL_GPIO_WritePin(WSB_EN_GPIO_Port, WSB_EN_Pin, GPIO_PIN_SET)
#define ACC_FANS_1_DISABLE HAL_GPIO_WritePin(WSB_EN_GPIO_Port, WSB_EN_Pin, GPIO_PIN_RESET)
...
#define VCU_EN HAL_GPIO_WritePin(CDU_EN_GPIO_Port, CDU_EN_Pin, GPIO_PIN_SET)
#define VCU_DISABLE HAL_GPIO_WritePin(CDU_EN_GPIO_Port, CDU_EN_Pin, GPIO_PIN_RESET)
...
// AUX
#define TRANSPONDER_EN HAL_GPIO_WritePin(AUX_1_PWR_GPIO_Port, AUX_1_PWR_Pin, GPIO_PIN_SET)
#define TRANSPONDER_DISABLE HAL_GPIO_WritePin(AUX_1_PWR_GPIO_Port, AUX_1_PWR_Pin, GPIO_PIN_RESET)
#define RADIATOR_2_EN HAL_GPIO_WritePin(AUX_2_PWR_GPIO_Port, AUX_2_PWR_Pin, GPIO_PIN_SET)
#define RADIATOR_2_DISABLE HAL_GPIO_WritePin(AUX_2_PWR_GPIO_Port, AUX_2_PWR_Pin, GPIO_PIN_RESET)
#define ACC_FANS_3_EN HAL_GPIO_WritePin(AUX_3_PWR_GPIO_Port, AUX_3_PWR_Pin, GPIO_PIN_SET)
#define ACC_FANS_3_DISABLE HAL_GPIO_WritePin(AUX_3_PWR_GPIO_Port, AUX_3_PWR_Pin, GPIO_PIN_RESET)
