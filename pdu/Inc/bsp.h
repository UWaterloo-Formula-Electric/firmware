...
#define IS_DC_DC_ON 		(HAL_GPIO_ReadPin(BMGR_DCOKn_GPIO_Port, BMGR_DCOKn_Pin) == GPIO_PIN_RESET)
#define BMGR_GPIO1_STATE	(HAL_GPIO_ReadPin(BMGR_GPIO1_GPIO_Port, BMGR_GPIO1_Pin) == GPIO_PIN_SET)
#define BMGR_GPIO2_STATE	(HAL_GPIO_ReadPin(BMGR_GPIO2_GPIO_Port, BMGR_GPIO2_Pin) == GPIO_PIN_SET)
#define BMGR_GPIO3_STATE	(HAL_GPIO_ReadPin(BMGR_GPIO3_GPIO_Port, BMGR_GPIO3_Pin) == GPIO_PIN_SET)
