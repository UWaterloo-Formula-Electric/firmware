...
LINT_TARGET ?= none
RUN_LINTER = cppcheck --addon=./common/Misra/misra.json --enable=all  -I $(LINT_TARGET)/Inc --output-file=$(LINT_DIR)/$(LINT_TARGET)-lint.log $(LINT_TARGET)/Src
...
$(BOARD_NAME): $(BOARD_NAME)_pre-build $(RELEASE_BIN_FILE)
